...
name: geo-proposal
description: >
  Auto-generate a professional, client-ready AI Visibility Intelligence Engagement from audit data.
  ...
  or after completing a AI visibility assessment for a prospect.
version: 1.0.0
...
Generate a fully customized, client-ready AI Visibility Intelligence Engagement that:
1. Pulls findings directly from the prospect's AI visibility assessment
...
3. Extract from audit:
   - AI Discoverability Readiness (overall and per-category)
...
### Step 3: Generate Engagement File
...
```markdown
# AI Visibility Intelligence Engagement
## [COMPANY NAME] — AI Search Visibility

**Prepared by:** Abderraouf-yt | AI Visibility Engineer
...
Our AI visibility assessment of [DOMAIN], conducted on [DATE], reveals a AI Discoverability Readiness
...
## The Opportunity: Why AI Discoverability Matters for [COMPANY NAME]
...
| Marketers investing in AI Discoverability today | Only 23% |

**First-mover advantage is real.** Companies that invest in AI Discoverability now will
...
|--------|-----------|------------------|----------------|
| AI Discoverability Readiness | [SCORE]/100 | 45/100 | 75+/100 |
...
### AI Discoverability Readiness Breakdown
...
| **TOTAL AI DISCOVERABILITY READINESS** | | | **[SCORE]/100** | **[TIER]** |
...
**What's included:**
- Quarterly full AI visibility assessment (4x/year)
...
- Monthly full AI visibility assessment + delta report
...
- **Proven methodology**: 11-dimension AI visibility assessment covering all major AI platforms
...
1. **Review this intelligence engagement** and share any questions
...
This engagement structure is valid for **30 days** from the date above.
...
are based on current industry best practices for AI Discoverability.*
```
