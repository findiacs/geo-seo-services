...
version: 1.0.0
author: ai-visibility-intelligence
...
- Run a full AI visibility assessment first (using `/geo-audit`) to have data to include in the report
...
1. **Check for existing audit data** — Look for recent AI visibility assessment reports in the current directory:
...
When extracting data from existing intelligence markdown reports, look for these patterns:

- **AI Discoverability Readiness**: Look for "AI Discoverability Readiness: XX/100" or "Overall: XX/100" or "AI Discoverability Readiness: XX"
